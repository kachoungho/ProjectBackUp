...
<c:forEach var="list" items="${list}">
	...
	<table width="670" border="0" cellspacing="1" cellpadding="2"
		...
		<tr bgcolor="#F5F5F5" align="center">
			...
			<td width="171" align="left">${list.stu_name}</td> <!-- 데이터 얻어 와야할 곳 -->
			<td width="120" bgcolor="#D0D8FF">전공명</td>
			<td width="250" colspan="3" align="left">&nbsp;${list.major}&nbsp;
			</td><!-- {데이터 얻어 와야할 곳 -->
		</tr>
		...
		<tr bgcolor="#F5F5F5" align="center">
			...
			<td width="171">${list.stu_birthday }</td><!-- {데이터 얻어 와야할 곳} -->

			<td width="120" bgcolor="#D0D8FF">학&nbsp;&nbsp;&nbsp;년</td>
			<td width="85">&nbsp;${list.grade }</td><!-- {데이터 얻어 와야할 곳} -->
			<td width="52" bgcolor="#D0D8FF">상&nbsp;태</td>
			<td width="101">&nbsp;${list.stu_state}</td><!-- {데이터 얻어 와야할 곳} -->
		</tr>

		<tr bgcolor="#F5F5F5" align="center">
			<td width="120" bgcolor="#D0D8FF" height="20">휴 대 폰</td>
			<td width="171" align="left">&nbsp;${list.tel} </td>
			<td width="120" bgcolor="#D0D8FF">이 메 일</td>
			<td width="250" colspan="3" align="left">&nbsp;${list.stu_email }</td>
		</tr>
		<tr bgcolor="#F5F5F5" align="center">
			<td width="68" bgcolor="#D0D8FF" height="20">주 소</td>
			<td width="591" colspan="5" align="left">&nbsp; ${list.address }</td><!-- {데이터 얻어 와야할 곳} -->
		
		</tr>
		
		<tr bgcolor="#F5F5F5" align="center">
			<td width="120" bgcolor="#D0D8FF" height="20">유선전화</td>
			<td width="171" colspan="6" align="left">&nbsp; ${list.home_tel }</td><!-- {데이터 얻어 와야할 곳} -->
		</tr>
