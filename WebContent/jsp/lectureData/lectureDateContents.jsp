...
<body>
	<center>
		...
		<table align="right">
			<tr>
				<td><input type="button" class="css_btn_class"  value="목록보기"
					onclick="document.location.href='lectureDate.do'"></td>
			</tr>
		</table>
		<br>
		<br>
		<form>
			<table width="70%" cellspacing="2" cellpadding="0" align="center">
				...
				<tr>
					...
					<td id="th2" align="center" width="500" colspan="3"
						style="word-wrap: break-word"><pre id="th3">${vo.lec_purpose }</pre></td>
				</tr>
				<tr>
					<td id="th" align="center" width="125" bgcolor="skyblue">교과목<br>개요
					</td>
					<td id="th2" align="left" width="500" colspan="3"
						style="word-wrap: break-word"><pre id="th3">${vo.lec_detail }</pre> </td>
				</tr>
